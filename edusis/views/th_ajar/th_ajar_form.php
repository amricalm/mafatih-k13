...
<div id="main">
    ...
    <?php $this->load->view('page_menu');?>
		...
		<div id="content" class="box">
			<h1>TAHUN AJAR</h1>
                <br />
                <form action="<?php echo base_url() ?>index.php/th_ajar/th_ajar_exec/db_add" method="POST" onsubmit="return validasi()">
    			<fieldset>
    				<legend>Tambah Tahun Ajar</legend>
    				<table class="nostyle" style="font-size: small;">
    					<tr>
    						<td class="va-top">Tahun Ajar</td>
                            <td>:</td>
                            <td><input type="text" size="40" name="th_ajar" id="th_ajar" class="input-text" /></td>
    					</tr>
    					<tr>
                            ...
                            <td>
                                <select name="nip" id="nip">
                                    ...
                                    <?php
                                        ...
                                        {
                                            echo '<option value="'.$rowpegawai->nip.'">'.$rowpegawai->nama_lengkap.'</option>';
                                        }
                                    ?>
                                </select>
                            </td>
