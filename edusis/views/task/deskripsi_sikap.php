...
<!-- Content (Right Column) -->
	<div id="content" class="box">
		<h1>DESKRIPSI SIKAP</h1>
<?php echo form_open('task/deskripsi_sikap/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
<table width="100%">
<tr>
...
<form action="<?php echo base_url().'index.php/task/inputCatatanSikap'?>" method="post">
...
<tr>
    ...
    <th width="20%">Nama Siswa</th>
		<th width="38%">Deskripsi Sikap Sosial</th>
    <th width="38%">Deskripsi Sikap Spiritual</th>
</tr>
    <?php
        $i = 1;
        if($this->input->post('submit'))
        {
            foreach($comment->result() as $row )
            {
                ...
                echo '<td class="va-top" cellpadding="0" cellspacing="0" ><textarea data-kolom="nilai" style="background:transparent; width: 100%; height:100px; border:none; font-size: 12px; resize:none; " name="comment'.($i-1).'" id="comment" >'.$row->comment.'</textarea></td>';
								echo '<td class="va-top" cellpadding="0" cellspacing="0"><textarea data-kolom="nilai" style="background:transparent; width: 100%; height:100px; border:none; font-size: 12px; resize:none; " name="comment'.($i-1).'" id="comment" >'.$row->comment_spiritual.'</textarea></td>';
								$i++;
                echo '</tr>';
            }
...
function simpan()
{
    ...
    else
    {
        ...
        {
            type    : 'POST',
            url     : '<?php echo base_url(); ?>index.php/task/aj_update_deskripsi_sikap',
            data    : {data:json},
            dataType: 'text',
