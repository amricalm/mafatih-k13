...
<!-- Content (Right Column) -->
	<div id="content" class="box">
		<h1>CATATAN PENGEMBANGAN DIRI</h1>
<?php echo form_open('task/catatan_kepribadian/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
<table width="100%">
<tr>
...
<form action="<?php echo base_url().'index.php/task/input_kepribadian'?>" method="post">
...
<tr>
    ...
    <th width="73%">Catatan Pengembangan Diri</th>
</tr>
    <?php
        $i = 1;
