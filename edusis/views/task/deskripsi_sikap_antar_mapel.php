...
<?php echo form_open('task/deskripsi_sikap_antar_mapel/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
<table width="100%">
<tr>
...
<form action="<?php echo base_url().'index.php/task/inputCatatanUmum'?>" method="post">
...
<tr>
    ...
    <th width="73%">Deskripsi Sikap Antar Mapel</th>
</tr>
    <?php
        $i = 1;
...
function simpan()
{
    ...
    $('#AdnTable tr').each(function(){
            ...
            {                
                ...
                var o = new NilaiDtl(kelas, $(nis).html(),deskripsi);
                AoA.push(o);
                iUrutan++;
            }
    });
...
function NilaiDtl(kelas, nis, deskripsi)
{
    this.kelas = kelas;
    this.nis = nis;
