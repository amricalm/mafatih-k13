...
<!-- Content (Right Column) -->
	<div id="content" class="box">
		<h1>DESKRIPSI PENGETAHUAN</h1>
<?php echo form_open('task/deskripsi_pengetahuan/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
<table width="100%">
<tr>
...
<form action="<?php //echo base_url().'index.php/task/inputCatatanPengetahuan'?>" method="post">
...
<tr>
    ...
    <th width="73%">Deskripsi Pengetahuan</th>
</tr>
    <?php
        $i = 1;
...
function simpan()
{
    ...
    else
    {
        ...
        {
            type    : 'POST',
            url     : '<?php echo base_url(); ?>index.php/task/aj_update_deskripsi_pengetahuan',
            data    : {data:json},
            dataType: 'text',
