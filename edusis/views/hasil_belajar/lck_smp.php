...
<div id="tab01">
    ...
    <table border="1" width="100%">
        <tr>
            ...
            <a href="<?php echo base_url().'index.php/export/export_ledger2_pdf/'.$this->uri->segment(3).'/'.$this->uri->segment(4); ?>" id="tombol_pdf" title="Print Rapor 2" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/pdf.png" />Raport.2</a>
            <a href="<?php echo base_url().'index.php/export/export_catatan_pdf/'.$this->uri->segment(3).'/'.$this->uri->segment(4); ?>" id="tombol_pdf" title="Print Rapor 3" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/pdf.png" />Raport.3  </a>
            <?php } ?>
            </td>  
        </tr>
        <tr>
