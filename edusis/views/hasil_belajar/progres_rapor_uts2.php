...
<div id="tab01">
    <form action="<?php echo base_url().'index.php/hasilbelajar/progres_rapor_uts2' ?>" method="POST" id="frmhasilbelajar">
...
<table border="1" width="100%">
    <tr>
        ...
        <a href="<?php echo base_url().'index.php/export/adn_export_progres_rapor_uts/'.$this->uri->segment(3).'/'.$this->uri->segment(4); ?>" id="tombol_pdf" title="Print Progres" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/pdf.png" />Progres</a>
        <!--
    ...
    <tr>
        ...
        <td>
            ...
            <?php
                $option = array(0=>"&nbsp;");
                foreach ($siswa['hBaris'] ->result() as $row)
                {   
                    $option = $option + array(trim($row->nis)=>$row->nama_lengkap) ;
                }
                //echo $nis;
                echo form_dropdown('nis',$option,$pilihnis,'id="nis"');
            ?>
    ...
    <table class="tables" align="center%" width="100%" cellpadding="0">
        ...
        { 
            ...
            echo '<td align="center">
                      <input name="" value="'.round($hasil[$seq]['NTGS']).'" style=" border:none; width:28px; text-align: center; background:transparent;" />
                  </td>
                  <td align="center">
                      <input name="" value="'.round($hasil[$seq]['NUH']).'" style=" border:none; width:28px; text-align: center; background:transparent;" />
                  </td>
                  <td align="center">
                      <input name="" value="'.round($hasil[$seq]['NUTS']).'" style=" border:none; width:28px; text-align: center; background:transparent;" />
                  </td>
                  <td align="center">
                      <input name="" value="'.round($hasil[$seq]['NA']).'" style=" font-weight: bold; border:none; width:28px; text-align: center; background:transparent;" />
                  </td>';
            $i++;
            $seq++;
        }
    ...
    <table class="tables" boeder="3">
        ...
        <tr>
            <td style=" font-weight: bold; width:100% ; height: 70px; font-family:bradley hand ITC; font-size:16px ; padding: 10px 10px; color: black; "><?php echo $comment; ?></td>
        </tr>
    </table>
    <?php } ?>
    <?php } ?>
