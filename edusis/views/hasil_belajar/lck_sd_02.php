...
<div id="tab01">
    ...
    ?>
              ...
              <?php if($this->uri->segment(3) != '' && $this->uri->segment(3) != '0' && $this->uri->segment(4) !='' && $this->uri->segment(4) !='0'){
                ...
                foreach($nilai_akhir->result() as $row)
                {
                  ...
                  if($kel <= 8) 
                  {
                    ...
                    echo '<td style="border:1px solid #cfcfcf;font-size: 0.8em/1.5;line-height:13px;padding:5px;">'.$nm_mp.'</td>';
            ...
            <table align="center" style="width: 100%; font-family: 'Arial';border-collapse: collapse">
              ...
              <?php /* if($this->uri->segment(3) != '' && $this->uri->segment(3) != '0' && $this->uri->segment(4) !='' && $this->uri->segment(4) !='0') {
                    ...
                    if (!empty($tinggibadan)) {
                      echo '<td style="border:1px solid #cfcfcf;text-align:center;">3</td>';
            ...
            <table align="center" style="width: 100%; font-family: 'Arial';border-collapse: collapse">
              ...
              <?php if ($this->session->userdata('kd_semester')=='2' && $this->session->userdata('sub_pnl')=='UAS') { ?>
                <tr>
                    ...
                    $naik_kelas = array('I'=>'II ( DUA )','II'=>'III ( TIGA )','III'=>'IV ( EMPAT )','IV'=>'V ( LIMA )','V'=>'VI ( ENAM )','VI'=>'LULUS');
                      foreach($naik_kelas as $keynaik_kelas=>$valuenaik_kelas)
                      {
                        if(trim($kelas_lama) == $keynaik_kelas) {
							if($this->uri->segment(4) == '181904028') {
								if ($this->session->userdata('th_ajar') == '2018/2019 ') {
									echo "<b>Tinggal di Kelas : ".$this->uri->segment(3)." ( EMPAT )</b>";
								}
							} else {
