...
<div id="main">
	...
	<h1>PROSES</a></h1>
    <?php echo form_open('hasilbelajar/proses_hitung_lck/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
	<table align="center" style="border: none;" class="daftar">
        ...
        <td>
            <input class="input button blue" type="submit" name="filter" value="Proses Hitung LCK"/>
        </td>
