...
<div id="main">
	...
	<h1>LEDGER DETAIL</a></h1>
    <?php echo form_open('hasilbelajar/ledger_detail/',array('name'=>'frmdaftar','id'=>'frmdaftar','onsubmit'=>'return submitbaru()')) ?>
	<table align="center" style="border: none;width: 100%;" class="daftar">
        ...
        <td align="right" width="600px" style="text-align: right;">
            <?php if($this->uri->segment(3)=='' || $this->uri->segment(3)=='0'){} else { ?>
                <a href="<?php echo base_url().'index.php/export/export_ledger_detail_pdf/'.$this->uri->segment(3).'/'.$this->uri->segment(4); ?>" id="tombol_pdf" title="Print Ledger <?php $q=($this->session->userdata('sub_pnl')=='UTS') ? 'UTS' : 'UAS'; echo $q; ?>" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/pdf.png" /></a>
            <?php } ?>
        </td> 
        </tr>
    </table>
        ...
        <tr>
            ...
            <?php 
                ...
                if($this->input->post('filter'))
                {
                    ...
                    echo '<th  width="5%"><a href="#" class="namalengkap" title="NR" style="color:white; text-decoration: none;text-transform:uppercase;">JMH</a></th>';                        
                    echo '<th  width="5%"><a href="#" class="namalengkap" title="NR" style="color:white; text-decoration: none;text-transform:uppercase;">NR</a></th>';                        
