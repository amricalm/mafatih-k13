...
<div id="main">
    ...
    <?php $this->load->view('page_menu');?>
		...
		<div id="content" class="box">
			...
			<div id="tab01">
            <form action="<?php echo base_url() ?>index.php/pelanggaran_siswa/pelanggaran_siswa_exec/db_add" method="POST" name="frmpelanggaran" id="frmpelanggaran">
            <fieldset>
    		<legend>Input Pelanggaran Siswa</legend>
    		<input type="hidden" name="kd_pelanggaran" id="kd_pelanggaran"/><input type="hidden" name="kelas" id="kelas" />		
            ...
            <tr>
                ...
                <td><input type="text" name="nm_pelanggaran" id="nm_pelanggaran" placeholder="Pelanggaran" class="input-text"/></td>
            </tr>
            <tr>
                <td class="va-top">Poin</td> 
                <td><input type="text" name="point" id="point" placeholder="Point"class="input-text"/></td>
            </tr>
            <tr>
                <td class="va-top">Kejadian</td>
                <td><textarea style="font-size : 14px; height:60px; width:300px;" name="kejadian" id="kejadian" class="input-text"></textarea></td>
            </tr>
            <tr>
                <td class="va-top">Hukuman</td>
                <td><textarea style="font-size : 14px; height:60px; width:300px;" name="hukuman" id="hukuman" class="input-text"></textarea></td>
            </tr>
            <tr>
                <td></td><td></td>
                <td>    
