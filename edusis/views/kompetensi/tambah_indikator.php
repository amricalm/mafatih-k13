...
<h1>INDIKATOR</h1>
<form action="<?php echo base_url() ?>index.php/kompetensi/indikator_exec/db_add/<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5).'/'.$this->uri->segment(6).'/'.$this->uri->segment(7).'/'.$this->uri->segment(8).'/'.$this->uri->segment(9); ?>" name="frmfilter" id="frmfilter" method="POST">
<fieldset>
<legend>Input Indikator</legend>
<table>
...
<input type="hidden" name="kd_idr" id="kd_idr" value="<?php echo $idr; ?>"/>
...
<!--<tr>
    ...
    <td><input type="text" disabled="disabled" name="kd_idr" id="kdidr" value="<?php //echo $idr; ?>"/></td>
</tr>-->
<tr>
    <td style="width:200px;" class="va-top">Indikator</td>
    <td><textarea name="ket_idr" id="ket_idr" style="font-size: 12px; width: 380px; height: 70px;" ></textarea></td>
</tr>
<tr>
    <td></td>
    <td>
