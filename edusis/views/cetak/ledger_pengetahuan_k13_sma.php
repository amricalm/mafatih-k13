...
<title style="text-transform: uppercase;">LEDGER PENGETAHUAN <?php echo $kelas ?></title>
<style>
  @media all {*{
...
<body>
  <table style="width: 100%;font-size: 11px;" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="left" colspan="2"><b>PENILAIAN PENGETAHUAN SEMESTER <?php echo $p_nl ?></b></td>
    </tr>
    <tr>
      ...
      if($this->uri->segment(3)!='' && $this->uri->segment(3)!='0' && $this->uri->segment(4) != '' && $this->uri->segment(4) != '0') {
        foreach($hasilbelajar as $row)
        {
          ...
          $brs .= '<td style="border: 1px solid black;text-align:left;">'.$row->nama_lengkap.'</td>';
              ...
              if ($k != 0) {
                $brs .= '<td style="border:1px solid black; font-weight: bold;">'.round($naRt).'</td>';
                $brs .= '<td style="border:1px solid black; font-weight: bold;">'.konversi(round($naRt)).'</td>';
