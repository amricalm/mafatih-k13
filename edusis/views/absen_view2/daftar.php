...
<body>
    ...
    <div id="main">
        ...
        <div id="content" class="box">
            ...
            <?php echo form_open('absen2/daftar/', array('name' => 'frmdaftar', 'id' => 'frmdaftar', 'onsubmit' => 'return submitbaru()')) ?>
                        ...
                        ?>
                                    <tr>
                                        <td colspan="4" style="border-bottom: none; border-right: none; border-left: none;" align="right">
                                            ...
                                            <input type="reset" name="reset" class="input-submit" value="Batal" onclick="javascript:window.location='<?php echo base_url() . 'index.php/absen2/daftar'; ?>'" />
                                        </td>
                                    </tr>
                        <?php
                                }
    ...
    <script type="text/javascript">
        function submitbaru() {
            ...
            var actionbaru = aksi + "/" + kelaspilih + "/" + bulanpilih;
