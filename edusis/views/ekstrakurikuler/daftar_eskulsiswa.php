...
<div id="content" class="box">
    <h1>EKSTRAKURIKULER SISWA</h1>
        ...
        <tr>
            ...
            <form action="<?php echo base_url().'index.php/eskulsiswa/daftar';?>" name="frmfilter" id="frmfilter" method="POST">
                <table border="1" width="100%">
                <tr>
            ...
            <td style="width: 60%;">
                <form action="<?php echo base_url().'index.php/eskulsiswa/simpan';?>" name="frmfilter" id="frmfilter" method="POST">
...
//untuk input nilai dari text box kedatabase
    function ambildatanilaieskul(kelas,nis)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url().'index.php/eskulsiswa/get_eskul_nis' ?>",
