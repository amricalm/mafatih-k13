			...
			<h1>PRESTASI SISWA </h1>
                ...
                <tr>
                    ...
                    <td style="border:none;text-align:right" rowspan="2">
                        ...
                        <a href="" id="tombol_add" onclick="return add('<?php echo base_url(); ?>index.php/prestasi/prestasi_siswa_form/db_add');" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/tambah.png" /></a>
                        <a href="" id="tombol_edit" onclick="return edit('<?php echo base_url(); ?>index.php/prestasi/prestasi_siswa_form/db_edit');" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/edit.png" /></a>
                        <a href="" id="tombol_del" onclick="return del('<?php echo base_url(); ?>index.php/prestasi/prestasi_siswa_form/db_del');" class="small button blue"><img src="<?php echo base_url(); ?>edusis_asset/edusisimg/hapus.png" /></a>
                        <?php //}?>
                    </td>
                </tr>
                </table>
                ...
                <tr>
                    ...
                    foreach($prestasisiswa->result() as $row)
                    {
                        $bg = ($seq%2==0) ? ' class="bg" ' : '';
                        echo '<tr'.$bg.'>';
                        echo '<td><input type="checkbox" id="'.$row->kd_prestasi_siswa.'" name="kode[]" /></td>';
