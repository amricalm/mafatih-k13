...
<div id="main">
    ...
    <?php $this->load->view('page_menu');?>
		...
		<div id="content" class="box">
            ...
            <form action="<?php echo base_url() ?>index.php/pelanggaran/tpelanggaran_exec/db_add" method="POST" name="frmpelanggaran" id="frmpelanggaran"> 
			<fieldset>
			...
			<table class="nostyle" style="font-size: small;">
                <tr>
					...
					<td><input type="text" size="40" name="kd_tpelanggaran" id="kd_tpelanggaran" class="input-long" /></td>
				</tr>
                <tr>
					<td>Nama Pelanggaran</td>
                    <td>:</td>
					<td><input type="text" size="40" name="nm_tpelanggaran" id="nm_tpelanggaran" class="input-text" /></td>
				</tr>
                <tr>
                <tr>
                    <td></td><td></td>
